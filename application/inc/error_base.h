...
typedef enum {
    ...
    ERROR_NVM_LUX_CALIBRATION_GAIN_NUMERATOR,
    ERROR_NVM_LUX_CALIBRATION_GAIN_DENOMINATOR,
    ERROR_NVM_UV_INDEX_CALIBRATION_GAIN_NUMERATOR,
    ERROR_NVM_UV_INDEX_CALIBRATION_GAIN_DENOMINATOR,
    ERROR_SIGFOX_EP_DL_OP_CODE,
    ERROR_SIGFOX_EP_DL_WEATHER_DATA_PERIOD,
    ERROR_SIGFOX_EP_DL_LUX_CALIBRATION_GAIN_NUMERATOR,
    ERROR_SIGFOX_EP_DL_LUX_CALIBRATION_GAIN_DENOMINATOR,
    ERROR_SIGFOX_EP_DL_UV_INDEX_CALIBRATION_GAIN_NUMERATOR,
    ERROR_SIGFOX_EP_DL_UV_INDEX_CALIBRATION_GAIN_DENOMINATOR,
    // Peripherals.
