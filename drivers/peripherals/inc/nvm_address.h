...
typedef enum {
    ...
    // Previous geolocation timestamp.
    NVM_ADDRESS_PREVIOUS_GEOLOC_YEAR,
    NVM_ADDRESS_PREVIOUS_GEOLOC_MONTH = (NVM_ADDRESS_PREVIOUS_GEOLOC_YEAR + 2),
    NVM_ADDRESS_PREVIOUS_GEOLOC_DATE,
    // Previous downlink timestamp.
    NVM_ADDRESS_PREVIOUS_DOWNLINK_YEAR,
    NVM_ADDRESS_PREVIOUS_DOWNLINK_MONTH = (NVM_ADDRESS_PREVIOUS_DOWNLINK_YEAR + 2),
    NVM_ADDRESS_PREVIOUS_DOWNLINK_DATE,
} NVM_address_t;
