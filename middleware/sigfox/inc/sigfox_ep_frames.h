...
/*!******************************************************************
 * \struct SIGFOX_EP_ul_payload_sunshine_light_unit_t
...
typedef union {
    ...
    struct {
        ...
        unsigned humidity_percent :7;
        unsigned sunshine_light :16;
        unsigned sunshine_uv_index_duvi :7;
        unsigned pressure_atmospheric_absolute_tenth_hpa :14;
#ifdef SPSWS_WIND_RAINFALL_MEASUREMENTS
        unsigned wind_speed_average_tenth_kmh :11;
        unsigned wind_speed_peak_tenth_kmh :11;
        unsigned wind_direction_average_degrees :9;
        unsigned rainfall :9;
#endif
    } __attribute__((scalar_storage_order("big-endian"))) __attribute__((packed));
